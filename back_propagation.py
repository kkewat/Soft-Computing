...
x2=1
alpha = 0.25
print('Calaculate a net input to z1 layer')
...
print('Apply actication function top calculate output')
...
print('z1=',z1)
print('z2=',z2)
print('CAlculate net input yo output layer')
yin = w[0]+z1*w[1]*w[2]
print('yin=',yin)
...
print('Changes in weights betwwn input and hidden layer')
dv11 = alpha * d1 *x1
print('dv11=',dv11)
dv21 = alpha *d1 * x2
print('dv21=',dv21)
...
print('Fianl Weights of network')
v1[0] = v1[0]+dv11
v1[1] = v1[1]+dv12
